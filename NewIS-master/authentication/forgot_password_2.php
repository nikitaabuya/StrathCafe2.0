	...
	<div class="container rounded border border-dark" style="margin-top:50px; margin-bottom:50px;">
		<div class="container">
			<div class="row">
				...
				<div class="col-md-11">
					<form action="forgot_password_process_2.php" method="post">
						<h1>Password Reset</h1><br>
						<div class="form-group">
							<label for="AdmissionNumber">Admission Number</label>
							<input class="form-control" type="number" name="AdmissionNumber" id="AdmissionNumber" placeholder="eg. 123456" required="true" />
						</div>
						<br>
						<div class="form-group">
							<label for="received_password">Received Password</label>
							<input class="form-control" type="password" name="received_password"
								placeholder="Enter the password you received" id="received_password" required>
						</div>
						<br>
						<div class="form-group">
							<label for="new_password">New Password</label>
							<input class="form-control" type="password" name="new_password"
								placeholder="Enter your new password" id="new_password" required>
						</div>
                        <br>
                        <div class="form-group">
							<label for="confirm_new_password">Confirm New Password</label>
							<input class="form-control" type="password" name="confirm_new_password"
								placeholder="Re-enter your new password" id="confirm_newpassword" required>
						</div>
						<br>
